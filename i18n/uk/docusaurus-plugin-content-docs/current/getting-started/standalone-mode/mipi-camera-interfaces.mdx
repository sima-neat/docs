...
**Modalix DevKit** містить два інтерфейси MIPI для підключення камери. Порти MIPI розташовані на материнській платі.
...
У U-Boot встановіть значення змінної `dtbos` на відповідний файл **Device Tree Blob Overlay** (`.dtbo`). Правильний файл залежить від **материнської плати**, **виробника камери**, **типу сенсора** та **порту камери**. Потім збережіть налаштування та завантажте операційну систему.
...
Наприклад, плата розширення Connectech з датчиком Leopard Imaging IMX477, підключеним до порту 0:
