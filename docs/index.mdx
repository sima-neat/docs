...
2. The MLSoC Modalix is loaded with a [NEAT application](https://developer.sima.ai/software) that defines the on-device inference pipeline.
...
2. The MLSoC Modalix is loaded with a [NEAT application](https://developer.sima.ai/software) packaging the inference pipeline and the adapted AI model.
