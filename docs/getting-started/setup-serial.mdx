...
<TabItem value="modalix-ea-pcie" label="Modalix EA PCIe Card">

<figure style={{margin: '0 auto 1rem', maxWidth: '780px', textAlign: 'center'}}>
  <img src="/img/devkit/modalix-ea-pcie-interfaces.jpg" alt="Modalix EA PCIe Card connectors" style={{width: '100%', borderRadius: 10}} />
  <figcaption style={{fontWeight: 'bold', marginTop: '0.5rem'}}>Modalix EA PCIe Card Connectors</figcaption>
</figure>
