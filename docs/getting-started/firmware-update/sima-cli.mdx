...
- Starting with firmware version `1.5`, PCIe mode can use a virtual Ethernet interface instead of physical network cabling to the DevKit.
- For firmware version `1.4` or earlier, establish a direct network connection with the DevKit. In this case, connect the DevKit in standalone mode.
:::
