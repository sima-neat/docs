...
<div className="card-grid">
  <a className="card devkit-card" href="/docs/hardware/devkit/modalix-devkit">
  ...
  <a className="card devkit-card" href="/docs/hardware/devkit/modalix-ea-kit">
  ...
  <a className="card devkit-card" href="/docs/hardware/devkit/modalix-ea-pcie">
...
| Preloaded Operating System | [eLxr Linux](/docs/hardware/getting-started/firmware-update/#os) | [eLxr Linux](/docs/hardware/getting-started/firmware-update/#os) | [eLxr Linux](/docs/hardware/getting-started/firmware-update/#os) |
| **Compute** | | | |
...
<a className="docs-button" href="/docs/hardware/getting-started/standalone-mode/">Set up Standalone Mode System Using DevKit</a>
...
<a className="docs-button" href="/docs/hardware/getting-started/pcie-mode">Set up a PCIe Mode System Using DevKit</a>
...
<div className="card-grid">
  ...
  <a className="card" href="/docs/hardware/getting-started/standalone-mode/">
    <h4>Standalone Mode</h4>
    <p>Run the MLSoC Modalix as a self-contained edge device — no host required.</p>
  </a>
  <a className="card" href="/docs/hardware/getting-started/pcie-mode">
    <h4>PCIe Mode</h4>
