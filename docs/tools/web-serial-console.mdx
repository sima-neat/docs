...
The **SiMa.ai Web Serial Console** connects to SiMa.ai DevKits from a Chromium-based browser through the [Web Serial API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Serial_API). No local installation is required. Open the tool in a compatible browser, plug in your DevKit via USB, and connect.
